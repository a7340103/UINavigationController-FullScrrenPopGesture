...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *sub1 = [ViewController new];
    sub1.view.backgroundColor = [UIColor redColor];
    TestNavController *nav1 = [[TestNavController alloc] initWithRootViewController:sub1];
    nav1.tabBarItem.title = @"sub1";
    [tabbar addChildViewController:nav1];
    
    ViewController *sub2 = [ViewController new];
    sub2.view.backgroundColor = [UIColor greenColor];
    TestNavController *nav2 = [[TestNavController alloc] initWithRootViewController:sub2];
    nav2.tabBarItem.title = @"sub2";
